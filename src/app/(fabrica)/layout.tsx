...
export default function FabricaLayout({
  ...
  const navItems = [
    ...
    { 
      ...
      submenu: [
        { href: '/fabrica/produccion', label: 'Control de Producción' },
        { href: '/fabrica/produccion/nueva', label: 'Nueva Producción' }
      ]
    },
    { 
      label: 'Recetas', 
      ...
      submenu: [
        { href: '/fabrica/recetas', label: 'Catálogo' }
      ]
    },
    { 
      label: 'Inventario', 
    ...
    { 
      ...
      submenu: [
        { href: '/fabrica/envios', label: 'Envíos' },
        { href: '/fabrica/envios/nuevo', label: 'Nuevo Envío' }
      ]
    },
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-[#4a292a]">
          <div className="flex items-center">
            ...
            />
            <h1 className="text-lg font-semibold text-[#eeb077]">Tulum Fábrica</h1>
          </div>
          <button 
        ...
        <div className="p-4 border-b border-[#4a292a]">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-[#eeb077]">Operador de fábrica</p>
            </div>
          </div>
        </div>
            ...
            <div className="relative">
              ...
              >
                <div className="hidden md:block text-right">
                  ...
                  <div className="text-xs text-[#9c7561]">Operador</div>
                </div>
