    ...
    <ContrastEnhancer>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-black">Nueva Producción</h1>
          <button
            type="button"
            onClick={() => router.back()}
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              <HCLabel htmlFor="recetaId">Receta</HCLabel>
              <HCSelect
                id="recetaId"
                {...register('recetaId')}
              >
            ...
            {selectedReceta && (
              <>
                <div>
                  <HCLabel htmlFor="cantidad">Cantidad a producir</HCLabel>
                  <HCInput
                    id="cantidad"
                    type="number"
                    min="1"
                ...
                <div>
                  <h3 className="text-md font-medium text-black mb-2">Insumos requeridos</h3>
                      ...
                      {selectedReceta.items.map(item => {
                        ...
                        return (
                          <li key={item.id} className="flex justify-between">
                            <div>
                              <span className="font-medium text-black">{item.insumo.nombre}:</span> 
                              <span className="ml-2 text-black">{cantidadNecesaria} {item.insumo.unidadMedida}</span>
                            </div>
            ...
            <div>
              <HCLabel htmlFor="observaciones">Observaciones</HCLabel>
              <HCTextarea
                id="observaciones"
                rows={3}
