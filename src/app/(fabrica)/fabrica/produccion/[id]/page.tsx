...
export default function DetalleProduccionPage({ params }: { params: { id: string } }) {
  ...
  <div className="space-y-4">
    <h4 className="font-medium text-lg text-gray-700">Finalizar producción</h4>
    ...
    <div>
      <label htmlFor="cantidadProducida" className="block text-sm font-medium text-gray-700 mb-1 justify-between">
