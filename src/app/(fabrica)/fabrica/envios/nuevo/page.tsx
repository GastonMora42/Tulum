// src/app/(fabrica)/fabrica/envios/nuevo/page.tsx
'use client';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            <label htmlFor="destinoId" className="block text-sm font-medium text-gray-700">
              Destino
            </label>
            <select
              id="destinoId"
          ...
          {/* Productos */}
          <div>
            <h3 className="text-md font-medium text-gray-700 mb-2">Productos a enviar</h3>
                ...
                return (
                  <div key={field.id} className="flex flex-col sm:flex-row gap-4 p-4 border rounded-md bg-gray-50">
                    <div className="sm:w-1/2">
                      <label 
                        htmlFor={`items.${index}.productoId`} 
                    ...
                    <div className="sm:w-1/4">
                      ...
                      <div className="flex items-center">
                        ...
                        <input
                          ...
                          className={`block w-full border-y border-gray-300 py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-center ${exceedsStock ? 'border-red-300 bg-red-50' : ''}`}
                        />
                        <button
                          type="button"
                          onClick={() => {
