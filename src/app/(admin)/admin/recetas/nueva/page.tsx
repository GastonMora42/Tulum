...
import { HCLabel, HCInput, HCTextarea, HCSelect } from '@/components/ui/HighContrastComponents';
      ...
      <div className="flex flex-col gap-6 p-4 md:gap-8 md:p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-black">Nueva Receta</h1>
          </div>
          <button
            type="button"
            onClick={() => router.back()}
