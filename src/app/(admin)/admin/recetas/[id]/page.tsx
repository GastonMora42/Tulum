// src/app/(admin)/admin/recetas/[id]/page.tsx
'use client';
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">Cargando datos de la receta...</p>
        </div>
      </div>
    );
  }
  ...
  if (!receta && !isFetchingData) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        <p className="text-destructive font-medium">Receta no encontrada</p>
        <button
          onClick={() => router.back()}
