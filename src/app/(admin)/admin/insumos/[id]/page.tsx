// src/app/(admin)/admin/insumos/[id]/page.tsx
'use client';
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">Cargando datos del insumo...</p>
        </div>
      </div>
    );
  }
  ...
  if (!insumo && !isFetchingData) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        <p className="text-destructive font-medium">Insumo no encontrado</p>
        <button
          onClick={() => router.back()}
    ...
    <div className="flex flex-col gap-6 p-4 md:gap-8 md:p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Editar Insumo</h1>
        </div>
        <button
          type="button"
          onClick={() => router.back()}
      ...
      <div className="rounded-lg border bg-card shadow p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <label htmlFor="unidadMedida" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                Unidad de Medida
              </label>
              <input
                id="unidadMedida"
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="space-y-2">
              <label htmlFor="stockMinimo" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                Stock Mínimo
              </label>
              <input
                id="stockMinimo"
            ...
            <div className="space-y-2">
              <label htmlFor="proveedorId" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                Proveedor (opcional)
              </label>
              <select
                id="proveedorId"
